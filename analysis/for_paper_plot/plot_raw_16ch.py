...
def plot_raw_16ch_waveform(input_file, output_file, sampling_rate, num_channels=15):
    """
    ...
    try:
        ...
        fig.suptitle(
            "Raw 16-Channel Sensor Waveforms (Takahashi Test)", fontsize=28, y=0.98
        )  # Increased font size
...
if __name__ == "__main__":
    ...
    plot_raw_16ch_waveform(
        args.input_file, args.output_file, args.sampling_rate, args.channels
    )
