...
measure_dates="0714 0807 0513 0512 1107 1130 1219 0714 0807 1115 1128 0512 0714 1001 1001 1001 1001 1001 1001 1109 1109 1109 1109"
dataset_date="0602"
subject_group="1"
...
#                 python3 vae_goto_val_pt.py --TARGET_NAME "$name" --epochs 500 --latent_size 4 --beta 1 --mode test --transform_type normal --Dataset_name 15ch_arrange_direction --loss_pt_on_off off --loss_pt_on_off_R_weight "$R_weight" --augumentation "$augumentation" --loss_pt_on_off_P_weight "$P_weight" --loss_pt_on_off_T_weight "$T_weight" --ave_data_flg $ave_data_flg
#             done
