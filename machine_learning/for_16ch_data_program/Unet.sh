...
for name in $measure_names; do
    python3 unet_goto_val.py --TARGET_NAME "$name" --epochs 300 --beta 1 --mode train --transform_type normal --Dataset_name for_Unet --loss_pt_on_off off --ave_data_flg $ave_data_flg
    python3 unet_goto_val.py --TARGET_NAME "$name" --epochs 300 --beta 1 --mode test --transform_type normal --Dataset_name for_Unet --loss_pt_on_off off  --ave_data_flg $ave_data_flg
done
