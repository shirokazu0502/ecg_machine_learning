...
def train_unet(
    ...
    for epoch in range(epochs):
        ...
        # early_stopping(total_test_loss / len(test_loader), model)
...
if __name__ == "__main__":
    current_time = "0702_1430_ch15_unet"
    ...
    parser.add_argument("--train_batch_size", type=int, default=32)  # default=256
