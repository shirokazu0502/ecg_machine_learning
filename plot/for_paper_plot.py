...
dataset_input_path = (
    OUTPUT_DIR,
    +"/figs_newref/0410_1000_not_prtsep/20250410_101505_Dataset_name=pqrst_nkmodule_since0310_cwt_transform_type=normal_test_TARGETNAME=goto_beta=1_alpha=300000_loss_pt_on_off=offPRT=1.00.0011.0_augument=",
)
...
for dataset_number in range(20):
    file_path = (
        dataset_input_path
        + f"plot_all_channel_8ch_2row_goto_1219_0.8s_0_dataset{str(dataset_number).zfill(3)}test_x_xo.svg"
    )
