...
def loss_fn_mse_and_corr(recon_x, x, beta=0.8):
...
def get_all_subject_names(dataset_name):
    """Gets a list of unique subject names (e.g., 'asano') from the data directory."""
    # This path might need to be adjusted based on the actual data directory structure
